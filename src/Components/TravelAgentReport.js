...
function TravelAgentReport() {
    ...
    const reportType = "Travel Agent Report"
    ...
    const columns = [
        {field:"cta_id", headerName:"CTA ID"},
        {field:"cta_email", headerName:"CTA Email"},
        {field:"bookingid", headerName:"Bokoing Id"},
        ...
        {field:"total", headerName:"Total (₹)", aggFunc:"sum", hide:true},
        {field:"payment_made", headerName:"Payment Made (₹)", aggFunc:"sum", hide:true},
        {field:"services_list", headerName:"Services List", hide:true},
        {field:"refund", headerName:"Refund (₹)", aggFunc:"sum", hide:true},
    ]
    ...
    const onGridReady = (params) => {
        ...
        // handleDataRequest("https://beta.stayflexi.com/api/v2/reports/getReportData/?hotel_id=12354&report_type=ctaReport&start_date=2021-01-01&end_date=2021-12-31&date_filter_mode=checkout")
    ...
    // calling the api 
    const calendarData = () => {
        handleDataRequest(`reports/getReportData/?hotel_id=12354&report_type=ctaReport&start_date=${dates[0].startDate}&end_date=${dates[0].endDate}&date_filter_mode=${filterDateType}`)
        .then((res) => setRowsData(res.report_data))
    }   
