...
function RoomRevenueReportSource() {
    ...
    const columns = [
        ...
        {field:"room_revenue", headerName:"Room Revenue (₹)", aggFunc:"sum", valueFormatter : (params) => params.value ? params.value.toFixed(2) : params.value },
        {field:"room_taxes", headerName:"Room Taxes (₹)", aggFunc:"sum", valueFormatter : (params) => params.value ? params.value.toFixed(2) : params.value },

        {field:"booking_amount", headerName:"Booking Amount (₹)", aggFunc:"sum", valueFormatter : (params) => params.value ? params.value.toFixed(2) : params.value, hide:true },
        {field:"offline_payment", headerName:"Offline Payment (₹)", aggFunc:"sum", valueFormatter : (params) => params.value ? params.value.toFixed(2) : params.value, hide:true },
        {field:"services_amount", headerName:"Services Amount (₹)", aggFunc:"sum", valueFormatter : (params) => params.value ? params.value.toFixed(2) : params.value, hide:true },
        {field:"external_payment_card", headerName:"External Payment Card (₹)", aggFunc:"sum", hide:true },
        {field:"payment_external", headerName:"External Payment (₹)", aggFunc:"sum", valueFormatter : (params) => params.value ? params.value.toFixed(2) : params.value, hide:true },
        {field:"payment_gateway_amount", headerName:"Payment Gateway Amount (₹)", aggFunc:"sum", hide:true},
        {field:"balance_amount", headerName:"Balance Amount (₹)", aggFunc:"sum", valueFormatter : (params) => params.value ? params.value.toFixed(2) : params.value, hide:true },
        {field:"total_amount_with_services", headerName:"Total Amount With Services (₹)", valueFormatter : (params) => params.value ? params.value.toFixed(2) : params.value, hide:true },
        {field:"refund", headerName:"Refund (₹)", aggFunc:"sum", valueFormatter : (params) => params.value ? params.value.toFixed(2) : params.value, hide:true },
    ]
    ...
    // calling the api 
    const calendarData = () => {
        handleDataRequest(`reports/getReportData/?hotel_id=12570&report_type=roomRevenueReportSource&start_date=${dates[0].startDate}&end_date=${dates[0].endDate}&date_filter_mode=${filterDateType}`)
        .then((res) => setRowsData(res.report_data))
    }   
...
export default RoomRevenueReportSource
