...
function CounterReport() {
    ...
    const columns = [
        ...
        {field:"amount", headerName:"Amount", aggFunc:"sum", enableValue:true, valueFormatter : (params) => {return Number(params.value.toFixed(2))} },
        {field:"cash_refund", headerName:"Cash Refund", aggFunc:"sum", enableValue:true, valueFormatter : (params) => {return Number(params.value.toFixed(2))} },
        {field:"customer_contact", headerName:"Customer Contact"},
        {field:"log_timestamp", headerName:"Log Timestamp",  filter:"agDateColumnFilter", filterParams:filterParams, hide:true},
        {field:"net_amount", headerName:"Net Amount", aggFunc:"sum", enableValue:true, valueFormatter : (params) => {return Number(params.value.toFixed(2))} },
        {field:"pos_order_id", headerName:"POS Order ID", hide:true},
        {field:"service_amount_desc", headerName:"Service Amount Description"},
        {field:"service_amount_type", headerName:"Service Amount Type"},
    ...
    const calendarData = () => {
        handleDataRequest(`https://beta.stayflexi.com/api/v2/reports/getReportData/?hotel_id=12354&report_type=counterReport&start_date=${dates[0].startDate}&end_date=${dates[0].endDate}`)
