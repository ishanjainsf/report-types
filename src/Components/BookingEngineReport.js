...
function BookingEngineReport() {
    ...
    const reportType = "Booking Engine Report"
    ...
    const columns = [
        ...
        {field:"roomtypes", headerName:"Room Types"},
        {field:"rate_plans", headerName:"Rate Plan(s)"},
        {field:"room_nights", headerName:"Room Nights"},
        {field:"room_ids", headerName:"Room ID(s)"},
        {field:"checkin", headerName:"Check In", filter:"agDateColumnFilter" ,filterParams:filterParams},
        {field:"checkout", headerName:"Checkout", filter:"agDateColumnFilter" ,filterParams:filterParams},
        {field:"booking_made_on", headerName:"Booked Date"},
        {field:"customer_info", headerName:"Customer Details"},
        {field:"status", headerName:"Booking Status"},
        {field:"total", headerName:"Booking Amount (₹)", aggFunc:"sum", valueFormatter: (params) => {return Number(params.value.toFixed(2))} },
        {field:"payment_made", headerName:"Payment Made (₹)", aggFunc:"sum", valueFormatter: (params) => {return Number(params.value.toFixed(2))}},
        {field:"user_name", headerName:"User Name", hide:true},
        {field:"booking_email", headerName:"Booking Email", hide:true},
        {field:"special_requests", headerName:"Special Requests", hide:true},
        {field:"service_list", headerName:"Service List", hide:true},
        {field:"refund", headerName:"Refund (₹)", valueFormatter: (params) => {return Number(params.value.toFixed(2))}, hide:true }
    ]
    ...
    const onGridReady = (params) => {
        ...
        // handleDataRequest("https://beta.stayflexi.com/api/v2/reports/getReportData/?hotel_id=12354&report_type=bookingEngineReport&start_date=2021-01-01&end_date=2021-12-31&date_filter_mode=checkout")
    ...
    // calling the api 
    const calendarData = () => {
        handleDataRequest(`reports/getReportData/?hotel_id=12354&report_type=bookingEngineReport&start_date=${dates[0].startDate}&end_date=${dates[0].endDate}&date_filter_mode=${filterDateType}`)
        .then((res) => setRowsData(res.report_data))
    }   
...
export default BookingEngineReport
