...
function OccupancyReport() {
    ...
    const reportType = "Occupancy Report"
    ...
    const columns = [
        ...
        {field:"roomtypes", headerName:"Room Types", ValueFormatter : (params) => {return params.value[0]} },
        {field:"occupiedStatus", headerName:"Occupancy Status"},
        {field:"bookingStatus", headerName:"Booking Status"},
        {field:"bookingId", headerName:"Booking ID"},
        {field:"ratePlan", headerName:"Rate Plan"},
        {field:"checkin", headerName:"Check In"},
        {field:"checkout", headerName:"Checkout"},
        {field:"customerName", headerName:"Customer Name"},
        {field:"customerEmail", headerName:"Customer Email"},
        {field:"bookingSource", headerName:"Booking Source"},
        {field:"bookingAmount", headerName:"Booking Amount (₹)", aggFunc:"sum"},
        ...
        onFilterChanged:(params)=>{
            ...
            setTimeout(()=>{
                params.api.forEachNodeAfterFilter(i=>{
                    result.bookingAmount +=i.data.bookingAmount;
                });
    ...
    function updatePinnedRowonDateChange(){
        ...
        rowsData.forEach(data => {
           result[0].bookingAmount += data.bookingAmount
        })
    ...
    // calling the api 
    const calendarData = () => {
        handleDataRequest(`reports/getReportData/?hotel_id=12354&report_type=occupancyReport&start_date=${dates[0].startDate}&end_date=${dates[0].endDate}&date_filter_mode=${filterDateType}`)
        .then((res) => setRowsData(res.report_data))
    }   
