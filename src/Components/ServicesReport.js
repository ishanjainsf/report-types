...
function ServicesReport() {
    ...
    const reportType = "Services Report"
    ...
    const columns = [
        ...
        {field:"service_description", headerName:"Service Type"},
        {field:"amount", headerName:"Service Amount (₹)"},
        {field:"service_tax", headerName:"Service Tax", aggFunc:"sum"},
        {field:'service_amount_type', headerName:"Amount Type"},
        {field:"log_timestamp", headerName:"Timestamp", filter: "agDateColumnFilter", filterParams: filterParams},
        {field:"service_date", headerName:"Service Date", filter:"agDateColumnFilter", filterParams: filterParams2, hide:true},
        {field:"pos_order_id", headerName:"POS Order ID", hide:true},
        {field:"user_email", headerName:"Customer Email", hide:true},
    ...
    const onGridReady = (params) => {
        ...
        // handleDataRequest("https://beta.stayflexi.com/api/v2/reports/getReportData/?hotel_id=12570&report_type=servicesReport&start_date=2021-01-01&end_date=2021-12-31&date_filter_mode=checkout")
        ...
        onFilterChanged:(params)=>{
            ...
            setTimeout(()=>{
                params.api.forEachNodeAfterFilter(i=>{
                    result.service_tax +=i.data.service_tax;
                });
    ...
    // calling the api 
    const calendarData = () => {
        handleDataRequest(`reports/getReportData/?hotel_id=12570&report_type=servicesReport&start_date=${dates[0].startDate}&end_date=${dates[0].endDate}`)
        .then((res) => setRowsData(res.report_data))
    }   
