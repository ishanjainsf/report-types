...
const PDFExportPanel = props => {
  ...
  const submitFormHandler = event => {
    ...
    printDoc(printParams, props.gridApi, props.columnApi, props.startdate, props.enddate, props.report_Type);
  };

  console.log(props.startdate, props.report_Type)
  ...
  return (
    <form onSubmit={submitFormHandler}>
      ...
      <div className="mb-2">
        ...
        />
        <label className="form-check-label" for="landscape" style={{marginLeft:"20px"}}>
          Landscape
        </label>
        <input
          className="form-check-input"
        ...
        />
        <label className="form-check-label" for="portrait" style={{marginLeft:"30px"}}>
          Portrait
        </label>
      </div>
